...
{% include image-gallery.html images="/asv_assembly.png, /asv_sea_trial.png" height="400" %}

### Manufacturing

<!-- Add manufacturing photos here when available -->
{% include image-gallery.html images="/asv_manufacturing_1.png, /asv_manufacturing_2.png" height="400" %}

### Sail & Keel Detail

{% include image-gallery.html images="/asv_sail.png, /asv_keel.png" height="400" %}
